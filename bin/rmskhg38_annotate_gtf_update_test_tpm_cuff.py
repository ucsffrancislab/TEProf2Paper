...
plus_dic = {}
print("Opening ",argdic['gencodeplusdic'])
with open(argdic['gencodeplusdic'],'rb') as DIC:
    plus_dic = pickle.load(DIC)

DIC.close()

minus_dic = {}
print("Opening ",argdic['gencodeminusdic'])
with open(argdic['gencodeminusdic'],'rb') as DIC:
